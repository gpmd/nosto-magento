...
class Dotenv_Loader
{
     ...
     *
     * @throws Dotenv_Exception_InvalidPathException
     *
     * @return void
     */
    protected function ensureFileIsReadable()
    {
        if (!is_readable($this->filePath) || !is_file($this->filePath)) {
            throw new Dotenv_Exception_InvalidPathException(sprintf('Unable to read the environment file at %s.', $this->filePath));
        }
    }
     ...
     *
     * This is not (currently) used by Dotenv_Dotenv but is provided as a utility
