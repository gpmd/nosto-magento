...
/**
 * Nosto_Seclib_Crypt_Base Class for all \phpseclib\Crypt\* cipher classes
 *
 * PHP version 5
 *
 ...
 *
 *  - The new \phpseclib\Crypt\* cipher class should extend Nosto_Seclib_Crypt_Base
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend Nosto_Seclib_Crypt_Base
 *    and take one of them as a start up for the new cipher class.
 *
 *  - Please read all the other comments/notes/hints here also for each class var/method
 *
 * @category  Crypt
 * @package   Nosto_Seclib_Crypt_Base
 ...
 * @author  Hans-Juergen Petrich <petrich@tronic-media.com>
 */
abstract class Nosto_Seclib_Crypt_Base
{
    /**#@+
     * @access public
     ...
     */
    /**
     * Nosto_Seclib_Crypt_Base value for the internal implementation $engine switch
     */
    const ENGINE_INTERNAL = 1;
    /**
     * Nosto_Seclib_Crypt_Base value for the mcrypt implementation $engine switch
     */
    ...
    function setPassword($password, $method = 'pbkdf2')
    {
        ...
        switch ($method) {
            default: // 'pbkdf2' or 'pbkdf1'
                ...
                switch (true) {
                    case $method == 'pbkdf1':
                        $hashObj = new Nosto_Seclib_Crypt_Hash();
                    ...
                    case !in_array($hash, hash_algos()):
                        ...
                        while (strlen($key) < $dkLen) {
                            $hmac = new Nosto_Seclib_Crypt_Hash();
                            $hmac->setHash($hash);
     ...
     * Pads a string
     *
     * Pads a string using the Nosto_Seclib_Crypt_RSA PKCS padding standards so that its length is a multiple of the blocksize.
