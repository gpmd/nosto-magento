 ...
 *
 * @category  Crypt
 * @package   Nosto_Seclib_Crypt_TripleDES
 ...
 * @access  public
 */
class Nosto_Seclib_Crypt_TripleDES extends Nosto_Seclib_Crypt_DES
{
    /**
     ...
     */
    const MODE_CBC3 = Nosto_Seclib_Crypt_Base::MODE_CBC;
    ...
    /**
     * The Nosto_Seclib_Crypt_DES objects
     *
     ...
     * @access public
     */
    function __construct($mode = Nosto_Seclib_Crypt_Base::MODE_CBC)
    {
        switch ($mode) {
            // In case of self::MODE_3CBC, we init as CRYPT_DES_MODE_CBC
            // and additional flag us internally as 3CBC
            case self::MODE_3CBC:
                parent::__construct(Nosto_Seclib_Crypt_Base::MODE_CBC);
                $this->mode_3cbc = true;

                // This three $des'es will do the 3CBC work (if $key > 64bits)
                $this->des = array(
                    new Nosto_Seclib_Crypt_DES(Nosto_Seclib_Crypt_Base::MODE_CBC),
                    new Nosto_Seclib_Crypt_DES(Nosto_Seclib_Crypt_Base::MODE_CBC),
                    new Nosto_Seclib_Crypt_DES(Nosto_Seclib_Crypt_Base::MODE_CBC),
                );
     ...
     *
     * Nosto_Seclib_Crypt_DES also requires that every eighth bit be a parity bit, however, we'll ignore that.
     *
