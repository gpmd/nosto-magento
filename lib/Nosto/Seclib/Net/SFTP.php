 ...
 * implemented by the popular OpenSSH Nosto_Seclib_Net_SFTP server".  If you want SFTPv4/5/6 support, provide me with access
 ...
 * @access  public
 */
class Nosto_Seclib_Net_SFTP extends Nosto_Seclib_Net_SSH2
{
    /**
     * Nosto_Seclib_Net_SFTP channel constant
     *
    ...
    */
    ...
    /**
     * Server Nosto_Seclib_Net_SFTP version
     *
     * @var int
     * @see self::_initChannel()
     * @access private
    ...
    /**
     * Max Nosto_Seclib_Net_SFTP Packet Size
     *
     * @see self::__construct()
     * @see self::get()
     * @var array
     ...
     * Default Constructor.
     *
     * Connects to an Nosto_Seclib_Net_SFTP server
     *
     * @param string $host
     * @param int $port
     * @param int $timeout
     * @return Nosto_Seclib_Net_SFTP
     * @access public
     */
     ...
     *
     * Nosto_Seclib_Net_SFTP doesn't provide a mechanism by which the current working directory can be changed, so we'll emulate it.  Returns
    ...
    function chdir($dir)
    {
        if (!($this->bitmap & Nosto_Seclib_Net_SSH2::MASK_LOGIN)) {
            return false;
        }
    ...
    /**
     * Recursively sets information on directories on the Nosto_Seclib_Net_SFTP server
     *
    ...
    /**
     * Uploads a file to the Nosto_Seclib_Net_SFTP server.
     *
    ...
    /**
     * Downloads a file from the Nosto_Seclib_Net_SFTP server.
     *
    ...
    /**
     * Deletes a file on the Nosto_Seclib_Net_SFTP server.
     *
     * @param string $path
     * @param bool $recursive
     * @return bool
    ...
    /**
     * Recursively deletes directories on the Nosto_Seclib_Net_SFTP server
     *
     * Minimizes directory lookups and SSH_FXP_STATUS requests for speed.
     *
     * @param string $path
    ...
    /**
     * Renames a file or a directory on the Nosto_Seclib_Net_SFTP server
     *
     ...
     *
     * Quoting the Nosto_Seclib_Net_SFTP RFC, "Implementations MUST NOT send bits that are not defined" but they seem to anyway
     *
     * @param int $mode
     * @return int
     * @access private
    ...
    /**
     * Sends Nosto_Seclib_Net_SFTP Packets
     *
    ...
    /**
     * Receives Nosto_Seclib_Net_SFTP Packets
     *
     * See '6. General Packet Format' of draft-ietf-secsh-filexfer-13 for more info.
     *
     * Incidentally, the number of SSH_MSG_CHANNEL_DATA messages has no bearing on the number of Nosto_Seclib_Net_SFTP packets present.
     * There can be one SSH_MSG_CHANNEL_DATA messages containing two Nosto_Seclib_Net_SFTP packets or there can be two SSH_MSG_CHANNEL_DATA
     * messages containing one Nosto_Seclib_Net_SFTP packet.
     *
     * @see self::_send_sftp_packet()
     * @return string
     * @access private
    ...
    /**
     * Get supported Nosto_Seclib_Net_SFTP versions
     *
     * @return array
     * @access public
     */
