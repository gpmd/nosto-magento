...
class Nosto_Seclib_Net_SSH2
{
    ...
    */
    ...
    /**
     * A System_SSH_Agent for use in the Nosto_Seclib_Net_SSH2 Nosto_Seclib_System_SSH_Agent Forwarding scenario
     *
    ...
    function _key_exchange($kexinit_payload_server = false)
    {
        ...
        $client_cookie = Nosto_Seclib_Crypt_Random::string(16);
        ...
        if ($kex_algorithm === 'curve25519-sha256@libssh.org') {
            $x = Nosto_Seclib_Crypt_Random::string(32);
            $eBytes = \Sodium\crypto_box_publickey_from_secretkey($x);
            $clientKexInitMessage = NET_SSH2_MSG_KEX_ECDH_INIT;
            $serverKexReplyMessage = NET_SSH2_MSG_KEX_ECDH_REPLY;
            $kexHash = new Nosto_Seclib_Crypt_Hash('sha256');
        } else {
            if (strpos($kex_algorithm, 'diffie-hellman-group-exchange') === 0) {
                ...
                $prime = new Nosto_Seclib_Math_BigInteger($primeBytes, -256);
                ...
                $g = new Nosto_Seclib_Math_BigInteger($gBytes, -256);
                ...
                $g = new Nosto_Seclib_Math_BigInteger(2);
                $prime = new Nosto_Seclib_Math_BigInteger($prime, 16);
            ...
            switch ($kex_algorithm) {
                case 'diffie-hellman-group-exchange-sha256':
                    ...
                    break;
                default:
                    $kexHash = new Nosto_Seclib_Crypt_Hash('sha1');
            }
        ...
        if ($kex_algorithm === 'curve25519-sha256@libssh.org') {
            ...
            $key = new Nosto_Seclib_Math_BigInteger(\Sodium\crypto_scalarmult($x, $fBytes), 256);
            \Sodium\memzero($x);
        } else {
            $f = new Nosto_Seclib_Math_BigInteger($fBytes, -256);
        ...
        switch ($mac_algorithm) {
            case 'hmac-sha2-256':
                $this->hmac_create = new Nosto_Seclib_Crypt_Hash('sha256');
                $createKeyLength = 32;
                break;
            case 'hmac-sha1':
                $this->hmac_create = new Nosto_Seclib_Crypt_Hash('sha1');
                $createKeyLength = 20;
                break;
            case 'hmac-sha1-96':
                $this->hmac_create = new Nosto_Seclib_Crypt_Hash('sha1-96');
                $createKeyLength = 20;
                break;
            case 'hmac-md5':
                $this->hmac_create = new Nosto_Seclib_Crypt_Hash('md5');
                $createKeyLength = 16;
                break;
            case 'hmac-md5-96':
                $this->hmac_create = new Nosto_Seclib_Crypt_Hash('md5-96');
                $createKeyLength = 16;
        }
        ...
        switch ($mac_algorithm) {
            case 'hmac-sha2-256':
                $this->hmac_check = new Nosto_Seclib_Crypt_Hash('sha256');
                $checkKeyLength = 32;
                $this->hmac_size = 32;
                break;
            case 'hmac-sha1':
                $this->hmac_check = new Nosto_Seclib_Crypt_Hash('sha1');
                $checkKeyLength = 20;
                $this->hmac_size = 20;
                break;
            case 'hmac-sha1-96':
                $this->hmac_check = new Nosto_Seclib_Crypt_Hash('sha1-96');
                $checkKeyLength = 20;
                $this->hmac_size = 12;
                break;
            case 'hmac-md5':
                $this->hmac_check = new Nosto_Seclib_Crypt_Hash('md5');
                $checkKeyLength = 16;
                $this->hmac_size = 16;
                break;
            case 'hmac-md5-96':
                $this->hmac_check = new Nosto_Seclib_Crypt_Hash('md5-96');
                $checkKeyLength = 16;
                $this->hmac_size = 12;
        }
     ...
     *
     * @param string $algorithm Name of the encryption algorithm
     * @return mixed Instance of Nosto_Seclib_Crypt_Base or null for unknown
     * @access private
     */
    function _encryption_algorithm_to_crypt_instance($algorithm)
    {
        switch ($algorithm) {
            case '3des-cbc':
                return new Nosto_Seclib_Crypt_TripleDES();
            case '3des-ctr':
                return new Nosto_Seclib_Crypt_TripleDES(Nosto_Seclib_Crypt_Base::MODE_CTR);
            case 'aes256-cbc':
            case 'aes192-cbc':
            case 'aes128-cbc':
                return new Nosto_Seclib_Crypt_Rijndael();
            case 'aes256-ctr':
            case 'aes192-ctr':
            case 'aes128-ctr':
                return new Nosto_Seclib_Crypt_Rijndael(Nosto_Seclib_Crypt_Base::MODE_CTR);
            case 'blowfish-cbc':
                return new Nosto_Seclib_Crypt_Blowfish();
            case 'blowfish-ctr':
                return new Nosto_Seclib_Crypt_Blowfish(Nosto_Seclib_Crypt_Base::MODE_CTR);
            case 'twofish128-cbc':
            case 'twofish192-cbc':
            case 'twofish256-cbc':
            case 'twofish-cbc':
                return new Nosto_Seclib_Crypt_Twofish();
            case 'twofish128-ctr':
            case 'twofish192-ctr':
            case 'twofish256-ctr':
                return new Nosto_Seclib_Crypt_Twofish(Nosto_Seclib_Crypt_Base::MODE_CTR);
            case 'arcfour':
            case 'arcfour128':
            case 'arcfour256':
                return new Nosto_Seclib_Crypt_RC4();
        }
        return null;
    }
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a Nosto_Seclib_Crypt_RSA object or an array
     *
    ...
    function _login_helper($username, $password = null)
    {
        ...
        if ($password instanceof Nosto_Seclib_Crypt_RSA) {
            return $this->_privatekey_login($username, $password);
        } elseif ($password instanceof Nosto_Seclib_System_SSH_Agent) {
     ...
     *
     * @param string $username
     * @param Nosto_Seclib_System_SSH_Agent $agent
     * @return bool
     * @access private
     */
    ...
    /**
     * Login with an Nosto_Seclib_Crypt_RSA private key
     *
     * @param string $username
     * @param Nosto_Seclib_Crypt_RSA $password
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
    ...
    function _privatekey_login($username, $privatekey)
    {
        ...
        $publickey = $privatekey->getPublicKey(Nosto_Seclib_Crypt_RSA::PUBLIC_FORMAT_RAW);
        if ($publickey === false) {
            return false;
        }
        ...
        $privatekey->setSignatureMode(Nosto_Seclib_Crypt_RSA::SIGNATURE_PKCS1);
    ...
    function _get_binary_packet($skip_channel_filter = false)
    {
        ...
        if ($remaining_length < -$this->decrypt_block_size || $remaining_length > 0x9000 || $remaining_length % $this->decrypt_block_size != 0) {
            if (!$this->bad_key_size_fix && $this->_bad_algorithm_candidate($this->decrypt_algorithm) && !($this->bitmap & static::MASK_LOGIN)) {
    ...
    function _send_binary_packet($data, $logged = null)
    {
        ...
        $padding = Nosto_Seclib_Crypt_Random::string($padding_length);
     ...
     *
     * Nosto_Seclib_Net_SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
     * and for Nosto_Seclib_Net_SFTP channels are presumably closed when the client disconnects.  This functions is intended
     * for Nosto_Seclib_Net_SCP more than anything.
     *
     * @param int $client_channel
    ...
    function getServerPublicHostKey()
    {
        ...
        switch ($this->signature_format) {
            case 'ssh-dss':
                $zero = new Nosto_Seclib_Math_BigInteger();

                if (strlen($server_public_host_key) < 4) {
                    return false;
                }
                $temp = unpack('Nlength', $this->_string_shift($server_public_host_key, 4));
                $p = new Nosto_Seclib_Math_BigInteger($this->_string_shift($server_public_host_key, $temp['length']), -256);

                if (strlen($server_public_host_key) < 4) {
                    return false;
                }
                $temp = unpack('Nlength', $this->_string_shift($server_public_host_key, 4));
                $q = new Nosto_Seclib_Math_BigInteger($this->_string_shift($server_public_host_key, $temp['length']), -256);

                if (strlen($server_public_host_key) < 4) {
                    return false;
                }
                $temp = unpack('Nlength', $this->_string_shift($server_public_host_key, 4));
                $g = new Nosto_Seclib_Math_BigInteger($this->_string_shift($server_public_host_key, $temp['length']), -256);

                if (strlen($server_public_host_key) < 4) {
                    return false;
                }
                $temp = unpack('Nlength', $this->_string_shift($server_public_host_key, 4));
                $y = new Nosto_Seclib_Math_BigInteger($this->_string_shift($server_public_host_key, $temp['length']), -256);
                ...
                $r = new Nosto_Seclib_Math_BigInteger($this->_string_shift($signature, 20), 256);
                $s = new Nosto_Seclib_Math_BigInteger($this->_string_shift($signature, 20), 256);
                ...
                $u1 = $w->multiply(new Nosto_Seclib_Math_BigInteger(sha1($this->exchange_hash), 16));
                list(, $u1) = $u1->divide($q);
            ...
            case 'ssh-rsa':
                ...
                $temp = unpack('Nlength', $this->_string_shift($server_public_host_key, 4));
                $e = new Nosto_Seclib_Math_BigInteger($this->_string_shift($server_public_host_key, $temp['length']), -256);
                ...
                $n = new Nosto_Seclib_Math_BigInteger($rawN, -256);
                ...
                */
                ...
                $temp = unpack('Nlength', $this->_string_shift($signature, 4));
                $s = new Nosto_Seclib_Math_BigInteger($this->_string_shift($signature, $temp['length']), 256);
                ...
                if ($s->compare(new Nosto_Seclib_Math_BigInteger()) < 0 || $s->compare($n->subtract(new Nosto_Seclib_Math_BigInteger(1))) > 0) {
                    user_error('Invalid signature');
                    return $this->_disconnect(NET_SSH2_DISCONNECT_KEY_EXCHANGE_FAILED);
                }
