 ...
 *
 * Instantiation should only be performed by Nosto_Seclib_System_SSH_Agent class.
 ...
 * @access  internal
 */
class Nosto_Seclib_System_SSH_Agent_Identity
{
    /**
     * Key Object
     *
     ...
     * @return Nosto_Seclib_System_SSH_Agent_Identity
     * @access private
     */
    ...
    function sign($message)
    {
        ...
        $packet = pack('CNa*Na*N', Nosto_Seclib_System_SSH_Agent::SSH_AGENTC_SIGN_REQUEST, strlen($this->key_blob), $this->key_blob, strlen($message), $message, 0);
        ...
        if ($type != Nosto_Seclib_System_SSH_Agent::SSH_AGENT_SIGN_RESPONSE) {
