 ...
 *
 * @category  File
 * @package   Nosto_Seclib_File_X509
...
class Nosto_Seclib_File_X509
{
    ...
    */
     ...
     *
     * There's no guarantee Nosto_Seclib_File_X509 is going to re-encode an X.509 cert in the same way it was originally
    ...
    function __construct()
    {
        ...
        $this->DirectoryString = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_CHOICE,
            'children' => array(
                'teletexString'   => array('type' => Nosto_Seclib_File_ASN1::TYPE_TELETEX_STRING),
                'printableString' => array('type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING),
                'universalString' => array('type' => Nosto_Seclib_File_ASN1::TYPE_UNIVERSAL_STRING),
                'utf8String'      => array('type' => Nosto_Seclib_File_ASN1::TYPE_UTF8_STRING),
                'bmpString'       => array('type' => Nosto_Seclib_File_ASN1::TYPE_BMP_STRING)
            )
        );
        ...
        $this->PKCS9String = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_CHOICE,
            'children' => array(
                'ia5String'       => array('type' => Nosto_Seclib_File_ASN1::TYPE_IA5_STRING),
                'directoryString' => $this->DirectoryString
            )
        );

        $this->AttributeValue = array('type' => Nosto_Seclib_File_ASN1::TYPE_ANY);

        $AttributeType = array('type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER);

        $AttributeTypeAndValue = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'children' => array(
                'type' => $AttributeType,
        ...
        */
        $this->RelativeDistinguishedName = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SET,
            'min'      => 1,
            'max'      => -1,
        ...
        $AlgorithmIdentifier = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'children' => array(
                'algorithm'  => array('type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER),
                'parameters' => array(
                                    'type'     => Nosto_Seclib_File_ASN1::TYPE_ANY,
                                    'optional' => true
                                )
            )
        );
        ...
        */
        $Extension = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'children' => array(
                'extnId'   => array('type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER),
                'critical' => array(
                                  'type'     => Nosto_Seclib_File_ASN1::TYPE_BOOLEAN,
                                  'optional' => true,
                                  'default'  => false
                              ),
                'extnValue' => array('type' => Nosto_Seclib_File_ASN1::TYPE_OCTET_STRING)
            )
        );
        ...
        $SubjectPublicKeyInfo = array(
            ...
            'children' => array(
                ...
                'subjectPublicKey' => array('type' => Nosto_Seclib_File_ASN1::TYPE_BIT_STRING)
            )
        );

        $UniqueIdentifier = array('type' => Nosto_Seclib_File_ASN1::TYPE_BIT_STRING);

        $Time = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_CHOICE,
            'children' => array(
                'utcTime'     => array('type' => Nosto_Seclib_File_ASN1::TYPE_UTC_TIME),
                'generalTime' => array('type' => Nosto_Seclib_File_ASN1::TYPE_GENERALIZED_TIME)
            )
        );
        ...
        $CertificateSerialNumber = array('type' => Nosto_Seclib_File_ASN1::TYPE_INTEGER);

        $Version = array(
            'type'    => Nosto_Seclib_File_ASN1::TYPE_INTEGER,
        ...
        $this->Certificate = array(
            ...
            'children' => array(
                 ...
                 'signature'          => array('type' => Nosto_Seclib_File_ASN1::TYPE_BIT_STRING)
            )
        );

        $this->KeyUsage = array(
            'type'    => Nosto_Seclib_File_ASN1::TYPE_BIT_STRING,
            'mapping' => array(
                'digitalSignature',
                'nonRepudiation',
                'keyEncipherment',
        ...
        $this->KeyIdentifier = array('type' => Nosto_Seclib_File_ASN1::TYPE_OCTET_STRING);

        $OrganizationalUnitNames = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'min'      => 1,
            'max'      => 4, // ub-organizational-units
            'children' => array('type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING)
        );
        ...
        $PersonalName = array(
            ...
            'children' => array(
                'surname'              => array(
                                           'type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING,
                                           'constant' => 0,
                                           'optional' => true,
                                           'implicit' => true
                                         ),
        ...
        $NumericUserIdentifier = array('type' => Nosto_Seclib_File_ASN1::TYPE_NUMERIC_STRING);

        $OrganizationName = array('type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING);

        $PrivateDomainName = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_CHOICE,
            'children' => array(
                'numeric'   => array('type' => Nosto_Seclib_File_ASN1::TYPE_NUMERIC_STRING),
                'printable' => array('type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING)
            )
        );

        $TerminalIdentifier = array('type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING);

        $NetworkAddress = array('type' => Nosto_Seclib_File_ASN1::TYPE_NUMERIC_STRING);
        ...
        $AdministrationDomainName = array(
            ...
            'class'    => Nosto_Seclib_File_ASN1::CLASS_APPLICATION,
            'cast'     => 2,
            'children' => array(
                'numeric'   => array('type' => Nosto_Seclib_File_ASN1::TYPE_NUMERIC_STRING),
                'printable' => array('type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING)
        ...
        $CountryName = array(
            ...
            'cast'     => 1,
            'children' => array(
                'x121-dcc-code'        => array('type' => Nosto_Seclib_File_ASN1::TYPE_NUMERIC_STRING),
                'iso-3166-alpha2-code' => array('type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING)
            )
        );
        ...
        $AnotherName = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'children' => array(
                 'type-id' => array('type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER),
                 'value'   => array(
                                  'type' => Nosto_Seclib_File_ASN1::TYPE_ANY,
                                  'constant' => 0,
                                  'optional' => true,
        ...
        $BuiltInDomainDefinedAttribute = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'children' => array(
                 'type'  => array('type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING),
                 'value' => array('type' => Nosto_Seclib_File_ASN1::TYPE_PRINTABLE_STRING)
            )
        );
        ...
        $GeneralName = array(
            ...
            'children' => array(
                ...
                'rfc822Name'                => array(
                                                 'type' => Nosto_Seclib_File_ASN1::TYPE_IA5_STRING,
                                                 'constant' => 1,
                                                 'optional' => true,
                                                 'implicit' => true
                                               ),
                ...
                'iPAddress'                 => array(
                                                 'type' => Nosto_Seclib_File_ASN1::TYPE_OCTET_STRING,
                                                 'constant' => 7,
                                                 'optional' => true,
                                                 'implicit' => true
                                               ),
                'registeredID'              => array(
                                                 'type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER,
                                                 'constant' => 8,
                                                 'optional' => true,
                                                 'implicit' => true
                                               )
        ...
        $PolicyQualifierId = array('type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER);

        $PolicyQualifierInfo = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'children' => array(
                'policyQualifierId' => $PolicyQualifierId,
                'qualifier'         => array('type' => Nosto_Seclib_File_ASN1::TYPE_ANY)
            )
        );

        $CertPolicyId = array('type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER);
        ...
        $KeyPurposeId = array('type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER);
        ...
        $AccessDescription = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'children' => array(
                'accessMethod'   => array('type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER),
        ...
        $this->PrivateKeyUsagePeriod = array(
            ...
            'children' => array(
                'notBefore' => array(
                                                 ...
                                                 'optional' => true,
                                                 'implicit' => true,
                                                 'type' => Nosto_Seclib_File_ASN1::TYPE_GENERALIZED_TIME),
                'notAfter'  => array(
                                                 'constant' => 1,
                                                 'optional' => true,
                                                 'implicit' => true,
        ...
        $BaseDistance = array('type' => Nosto_Seclib_File_ASN1::TYPE_INTEGER);
        ...
        $GeneralSubtree = array(
            ...
            'children' => array(
                ...
                'minimum' => array(
                                 ...
                                 'optional' => true,
                                 'implicit' => true,
                                 'default' => new Nosto_Seclib_Math_BigInteger(0)
                             ) + $BaseDistance,
                'maximum' => array(
                                 'constant' => 1,
                                 'optional' => true,
        ...
        $this->CPSuri = array('type' => Nosto_Seclib_File_ASN1::TYPE_IA5_STRING);

        $DisplayText = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_CHOICE,
            'children' => array(
                'ia5String'     => array('type' => Nosto_Seclib_File_ASN1::TYPE_IA5_STRING),
                'visibleString' => array('type' => Nosto_Seclib_File_ASN1::TYPE_VISIBLE_STRING),
                'bmpString'     => array('type' => Nosto_Seclib_File_ASN1::TYPE_BMP_STRING),
                'utf8String'    => array('type' => Nosto_Seclib_File_ASN1::TYPE_UTF8_STRING)
            )
        );
        ...
        $NoticeReference = array(
            ...
            'children' => array(
                ...
                'noticeNumbers' => array(
                                       ...
                                       'min'      => 1,
                                       'max'      => 200,
                                       'children' => array('type' => Nosto_Seclib_File_ASN1::TYPE_INTEGER)
                                   )
            )
        );
        ...
        $this->netscape_comment = array('type' => Nosto_Seclib_File_ASN1::TYPE_IA5_STRING);
        $this->netscape_ca_policy_url = array('type' => Nosto_Seclib_File_ASN1::TYPE_IA5_STRING);
        ...
        $this->CRLNumber = array('type' => Nosto_Seclib_File_ASN1::TYPE_INTEGER);

        $this->CRLReason = array('type' => Nosto_Seclib_File_ASN1::TYPE_ENUMERATED,
           'mapping' => array(
                            'unspecified',
                            'keyCompromise',
                            'cACompromise',
        ...
        $this->IssuingDistributionPoint = array('type' => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'children' => array(
                'distributionPoint'          => array(
                                                    'constant' => 0,
                                                    'optional' => true,
        ...
        $this->InvalidityDate = array('type' => Nosto_Seclib_File_ASN1::TYPE_GENERALIZED_TIME);

        $this->CertificateIssuer = $GeneralNames;

        $this->HoldInstructionCode = array('type' => Nosto_Seclib_File_ASN1::TYPE_OBJECT_IDENTIFIER);

        $PublicKeyAndChallenge = array(
            'type'     => Nosto_Seclib_File_ASN1::TYPE_SEQUENCE,
            'children' => array(
                'spki'      => $SubjectPublicKeyInfo,
                'challenge' => array('type' => Nosto_Seclib_File_ASN1::TYPE_IA5_STRING)
            )
        );
    ...
    function loadX509($cert, $mode = self::FORMAT_AUTO_DETECT)
    {
        ...
        $asn1 = new Nosto_Seclib_File_ASN1();
    ...
    function saveX509($cert, $format = self::FORMAT_PEM)
    {
        ...
        $filters = array();
        $type_utf8_string = array('type' => Nosto_Seclib_File_ASN1::TYPE_UTF8_STRING);
        ...
        $filters['policyQualifiers']['qualifier']
            = array('type' => Nosto_Seclib_File_ASN1::TYPE_IA5_STRING);
    ...
    function _mapOutExtensions(&$root, $path, $asn1)
    {
        ...
        if (is_array($extensions)) {
            ...
            for ($i = 0; $i < $size; $i++) {
                if ($extensions[$i] instanceof Nosto_Seclib_File_ASN1_Element) {
                    continue;
                }
                        ...
                        for ($j = 0; $j < count($value); $j++) {
                            ...
                            for ($k = 0; $k < count($value[$j]['policyQualifiers']); $k++) {
                                ...
                                if ($map !== false) {
                                    ...
                                    $subvalue = new Nosto_Seclib_File_ASN1_Element($asn1->encodeDER($subvalue, $map));
                                }
                            }
                        }
                        break;
                    case 'id-ce-authorityKeyIdentifier': // use 00 as the serial number instead of an empty string
                        if (isset($value['authorityCertSerialNumber'])) {
                            if ($value['authorityCertSerialNumber']->toBytes() == '') {
                                $temp = chr((Nosto_Seclib_File_ASN1::CLASS_CONTEXT_SPECIFIC << 6) | 2) . "\1\0";
                                $value['authorityCertSerialNumber'] = new Nosto_Seclib_File_ASN1_Element($temp);
                            }
                        }
                }
        ...
        if (is_array($dns)) {
            for ($i = 0; $i < count($dns); $i++) {
                for ($j = 0; $j < count($dns[$i]); $j++) {
                    $type = $dns[$i][$j]['type'];
                    $value = &$dns[$i][$j]['value'];
                    if (is_object($value) && $value instanceof Nosto_Seclib_File_ASN1_Element) {
        ...
        if (is_array($dns)) {
            ...
            for ($i = 0; $i < $size; $i++) {
                for ($j = 0; $j < count($dns[$i]); $j++) {
                    ...
                    $map = $this->_getMapping($type);
                    if (!is_bool($map)) {
                        $value = new Nosto_Seclib_File_ASN1_Element($asn1->encodeDER($value, $map));
                    }
                }
            }
        }
    ...
    function _validateSignature($publicKeyAlgorithm, $publicKey, $signatureAlgorithm, $signature, $signatureSubject)
    {
        switch ($publicKeyAlgorithm) {
            case 'rsaEncryption':
                $rsa = new Nosto_Seclib_Crypt_RSA();
                ...
                switch ($signatureAlgorithm) {
                    ...
                    case 'sha512WithRSAEncryption':
                        ...
                        $rsa->setSignatureMode(Nosto_Seclib_Crypt_RSA::SIGNATURE_PKCS1);
    ...
    function getDNProp($propName, $dn = null, $withType = false)
    {
        ...
        $asn1->loadOIDs($this->oids);
        $filters = array();
        $filters['value'] = array('type' => Nosto_Seclib_File_ASN1::TYPE_UTF8_STRING);
        $asn1->loadFilters($filters);
        ...
        for ($i = 0; $i < count($dn); $i++) {
            if ($dn[$i][0]['type'] == $propName) {
                ...
                if (!$withType) {
                    ...
                    } elseif (is_object($v) && $v instanceof Nosto_Seclib_File_ASN1_Element) {
    ...
    function getDN($format = self::DN_ARRAY, $dn = null)
    {
        ...
        switch ((int) $format) {
            ...
            case self::DN_ASN1:
                ...
                $asn1->loadOIDs($this->oids);
                $filters = array();
                $filters['rdnSequence']['value'] = array('type' => Nosto_Seclib_File_ASN1::TYPE_UTF8_STRING);
                $asn1->loadFilters($filters);
                $this->_mapOutDNs($dn, 'rdnSequence', $asn1);
            ...
            case self::DN_HASH:
                ...
                $hash = new Nosto_Seclib_Crypt_Hash('sha1');
                $hash = $hash->hash($dn);
     ...
     * Set public key
     *
     * Key needs to be a Nosto_Seclib_Crypt_RSA object
     *
     * @param object $key
     * @access public
     * @return bool
     ...
     * Gets the public key
     *
     * Returns a Nosto_Seclib_Crypt_RSA object or a false.
     *
     * @access public
     * @return mixed
     */
    function getPublicKey()
    {
        ...
        switch ($keyinfo['algorithm']['algorithm']) {
            case 'rsaEncryption':
                $publicKey = new Nosto_Seclib_Crypt_RSA();
    ...
    function loadCSR($csr, $mode = self::FORMAT_AUTO_DETECT)
    {
        ...
        switch ($algorithm) {
            case 'rsaEncryption':
                $this->publicKey = new Nosto_Seclib_Crypt_RSA();
    ...
    function saveCSR($csr, $format = self::FORMAT_PEM)
    {
        ...
        $filters['certificationRequestInfo']['subject']['rdnSequence']['value']
            = array('type' => Nosto_Seclib_File_ASN1::TYPE_UTF8_STRING);
    ...
    function saveCRL($crl, $format = self::FORMAT_PEM)
    {
        ...
        if (empty($crl['tbsCertList']['signature']['parameters'])) {
            $filters['tbsCertList']['signature']['parameters']
                = array('type' => Nosto_Seclib_File_ASN1::TYPE_NULL);
        }
    ...
    {
        if ($date instanceof Nosto_Seclib_File_ASN1_Element) {
            return $date;
        }
     ...
     *
     * @param Nosto_Seclib_File_X509 $issuer
     * @param Nosto_Seclib_File_X509 $subject
        ...
        if (isset($subject->currentCert) && is_array($subject->currentCert) && isset($subject->currentCert['tbsCertificate'])) {
            ...
            */
            $serialNumber = !empty($this->serialNumber) ?
                $this->serialNumber :
                new Nosto_Seclib_Math_BigInteger(Nosto_Seclib_Crypt_Random::string(20) & ("\x7F" . str_repeat("\xFF", 19)), 256);
     ...
     *
     * @param Nosto_Seclib_File_X509 $issuer
     * @param Nosto_Seclib_File_X509 $crl
     * @param string $signatureAlgorithm optional
     * @access public
     * @return mixed
     */
    function signCRL($issuer, $crl, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (!empty($this->serialNumber)) {
            ...
            $crlNumber = $crlNumber !== false ? $crlNumber->add(new Nosto_Seclib_Math_BigInteger(1)) : null;
        }
    ...
    {
        if ($key instanceof Nosto_Seclib_Crypt_RSA) {
            switch ($signatureAlgorithm) {
                case 'md2WithRSAEncryption':
                case 'md5WithRSAEncryption':
                case 'sha1WithRSAEncryption':
                ...
                case 'sha512WithRSAEncryption':
                    ...
                    $key->setSignatureMode(Nosto_Seclib_Crypt_RSA::SIGNATURE_PKCS1);
    ...
    function setEndDate($date)
    {
        ...
        */
        if (strtolower($date) == 'lifetime') {
            ...
            $asn1 = new Nosto_Seclib_File_ASN1();
            $temp = chr(Nosto_Seclib_File_ASN1::TYPE_GENERALIZED_TIME) . $asn1->_encodeLength(strlen($temp)) . $temp;
            $this->endDate = new Nosto_Seclib_File_ASN1_Element($temp);
        } else {
            if (!is_object($date) || !is_a($date, 'DateTime')) {
                $date = new DateTime($date, new DateTimeZone(@date_default_timezone_get()));
            }
    ...
    {
        $this->serialNumber = new Nosto_Seclib_Math_BigInteger($serial, $base);
    }
     ...
     * - Key object
     * - Nosto_Seclib_File_X509 object with public or private key defined
     * - Certificate or CSR array
     * - Nosto_Seclib_File_ASN1_Element object
     * - PEM or DER string
     *
    ...
    function computeKeyIdentifier($key = null, $method = 1)
    {
        ...
        switch (true) {
            ...
            case !is_object($key):
                return false;
            case $key instanceof Nosto_Seclib_File_ASN1_Element:
                ...
                $raw = $asn1->asn1map($decoded[0], array('type' => Nosto_Seclib_File_ASN1::TYPE_BIT_STRING));
                if (empty($raw)) {
                    return false;
                }
                $raw = base64_decode($raw);
                // If the key is private, compute identifier from its corresponding public key.
                $key = new Nosto_Seclib_Crypt_RSA();
                if (!$key->loadKey($raw)) {
            ...
            default: // Should be a key object (i.e.: \phpseclib\Crypt\RSA).
                $key = $key->getPublicKey(Nosto_Seclib_Crypt_RSA::PUBLIC_FORMAT_PKCS1);
                break;
        }
    ...
    {
        if ($this->publicKey instanceof Nosto_Seclib_Crypt_RSA) {
            // the following two return statements do the same thing. i dunno.. i just prefer the later for some reason.
            // the former is a good example of how to do fuzzing on the public key
            //return new Element(base64_decode(preg_replace('#-.+-|[\r\n]#', '', $this->publicKey->getPublicKey())));
            return array(
                'algorithm' => array('algorithm' => 'rsaEncryption'),
                'subjectPublicKey' => $this->publicKey->getPublicKey(Nosto_Seclib_Crypt_RSA::PUBLIC_FORMAT_PKCS1)
            );
        }
    ...
    {
        $serial = new Nosto_Seclib_Math_BigInteger($serial);
