...
/**
 * Pure-PHP Nosto_Seclib_File_ANSI Decoder
 *
 * PHP version 5
 *
 * If you call read() in \phpseclib\Net\SSH2 you may get {@link http://en.wikipedia.org/wiki/ANSI_escape_code Nosto_Seclib_File_ANSI escape codes} back.
 * They'd look like chr(0x1B) . '[00m' or whatever (0x1B = ESC).  They tell a
 * {@link http://en.wikipedia.org/wiki/Terminal_emulator terminal emulator} how to format the characters, what
 * color to display them in, etc. Nosto_Seclib_File_ANSI is a {@link http://en.wikipedia.org/wiki/VT100 VT100} terminal emulator.
 *
 * @category  File
 * @package   Nosto_Seclib_File_ANSI
...
class Nosto_Seclib_File_ANSI
{
    ...
    /**
     * Current Nosto_Seclib_File_ANSI code
     *
     * @var string
     * @access private
     */
